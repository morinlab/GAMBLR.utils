...
#' all_sample_seg = GAMBLR.open::get_cn_segments(these_samples_metadata = cell_line_meta)
...
#'
#' multi_sample_seg = dplyr::filter(all_sample_seg, sample %in% c("DOHH-2", "SU-DHL-4"))
