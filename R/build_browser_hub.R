...
#'
#' @param maf_data 
#' @param regions_bed A BED-format table where columns 1, 2 and 3 are chromosome names, start position and end position, respectively. 
#' @param regions_description possible values: "ashm", "coding". ignored if regions_bed is provided.
#' @param all_ashm_only 
...
#' @param hub_dir 
#' @param as_bigbed 
#' @param splitColumnName An single string to indicate which metadata column is used to split the 
#'   data into custom track files. Default is set to "pathology".
#' @param hub_name 
#' @param shortLabel 
#' @param longLabel 
#' @param email 
#' @param visibility 
#' @param bigDataUrl_dir 
#'
#' @return
#' @export
#'
